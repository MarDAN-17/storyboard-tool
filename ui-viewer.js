...
const UIViewer = (() => {
  ...
  /**
   * Initialise la vue consultation.
   * @param {Object} module - module de storyboard déjà chargé
   * @param {Object} refs - références DOM { rail, slides, searchInput, statutChips, titleEl, seqEl }
   */
